    ...
    else
    {
        ...
        if (contaCliente->validaSenha(senhain))
        {
            ...
            while (atendimento) //Realiza o atendimento
            {
                ...
                cout << "Qual operacao deseja fazer? (1 - Saque, 2 - Deposito, 3 - Ver Saldo, 4 - Transferir, 5 - Sair): ";
                cin >> op;
                switch (op)
                {
                case 1:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    cout << "Digite o numero da conta de tranferencia:"<<endl;
                    cin >> numContaDestino;
                    
                    contaDestino = this->buscaConta(numContaDestino);

                    if (contaDestino == nullptr) {
                        cout << "Conta de transferência não existe" << endl;
                        break;
                    }

                    float valorParaTransferir = 0;
                    cout << "Digite o valor a ser transferido: "<<endl;
                    cin >> valorParaTransferir;

                    contaCliente->transferir(valorParaTransferir, contaDestino, senhain);
